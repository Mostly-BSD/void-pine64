...
VOID_PLATFORMFS_NAME="void-pine64-A64-musl-PLATFORMFS-${VOID_LOCAL_ROOTFS_VERSION}.tar.xz"
VOID_LOCAL_ROOTFS_NAME="void-aarch64-musl-ROOTFS-${VOID_LOCAL_ROOTFS_VERSION}.tar.xz"
VOID_REMOTE_ROOTFS_NAME="void-aarch64-musl-ROOTFS-${VOID_REMOTE_ROOTFS_VERSION}.tar.xz"
...
IMAGE_NAME="${1:-void-pine64-A64plus-musl.img}"
