...
PROOT_NO_SECCOMP=1 TERM=xterm-256color proot -q qemu-aarch64-static -b ./files:/opt/files -b ../../void-linux/void-packages/hostdir/binpkgs/pine64:/opt/pine64 -S ./sdcard/root /tmp/${SCRIPT_NAME}
